...
KE = I1.*dq1.*(1.0./2.0)+I2.*dq2.*(1.0./2.0)+I3.*dq3.*(1.0./2.0)+I4.*dq4.*(1.0./2.0)+I5.*dq5.*(1.0./2.0)+m1.*(t3.^2.*t4+t4.*t6.^2).*(1.0./2.0)+m2.*(t8.^2+t10.^2).*(1.0./2.0)+m3.*(t13.^2+t16.^2).*(1.0./2.0)+m4.*(t18.^2+t20.^2).*(1.0./2.0)+m5.*(t22.^2+t24.^2).*(1.0./2.0);
if nargout > 1
    PE = g.*m2.*(t26+t27-t30)-g.*m1.*t3+g.*m4.*(t26+t27-c4.*t23)+g.*m3.*(-t25+t26+t27+t28)+g.*m5.*(t26+t27-c5.*t29-l4.*t23);
end
